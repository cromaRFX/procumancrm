...
$mod_strings = array (
  ...
  'LNK_MANAGE_BUCKETS' => 'Bucket Manager',
  'LBL_GROUPING_ID' => 'Grouping ID',
  'LBL_GROUPING_NAME' => 'Grouping Name',
  'LBL_GROUPING_DESCRIPTION' => 'Description',
  'LBL_GROUPING_MODULENAME' => 'Module Name',
  'LBL_GROUPING_FIELDNAME' => 'Field Name',
  'LBL_GROUPING_MAPPING' => 'Mapping',
  'LBL_GROUPING_CREATE' => 'Create New Grouping',
  'LBL_GROUPING_ENUMFIELDS' => 'Available fields',
  'LBL_MAPPING_VALUE' => 'Mapping Name',
  'LBL_MAPPING_NEWVALUE' => 'New Mapping',
  'LBL_MAPPING_PROMPT_NAME' => 'Please, enter a name',
  'LBL_ENUMVALUE_ID' => 'ID',
  'LBL_ENUMVALUE_VALUE' => 'Value',
  'LBL_ENUMVALUE_LABEL' => 'Label',
  'LBL_ENUMVALUE_HANDLER' => 'Group remaining values into \'others\'',
  'LBL_GRID_GROUPINGS' => 'Groupings',
  'LBL_GRID_MODULEFIELD' => 'Source',
  'LBL_GRID_MAPPINGS' => 'Mappings',
  'LBL_GRID_ENUMVALUES' => '<< Drag Values',
  'LBL_ERROR_REQUIREDALL' => 'All fields are required!',
  'LBL_ERROR_DELETEGROUPING' => 'Grouping could not be deleted. Please, check Sugar log.',
  'LBL_ERROR_UPDATEGROUPING' => 'Grouping could not be saved. Please, check Sugar log.',
  'LBL_ERROR_NOGROUPINGSELECTED' => 'Please, select a grouping!',
  'LNK_MANAGE_DLISTS' => 'DList Manager',
  'LBL_GRID_DLISTS' => 'Distributions lists',
  'LBL_DLIST_FILTER' => 'Filter',
  'LBL_DLIST_SEARCH' => 'Search',
  'LBL_DLIST_ID' => 'ID',
  'LBL_DLIST_NAME' => 'Name',
  'LBL_DLIST_USER_ID' => 'User ID',
  'LBL_DLIST_USER_USERNAME' => 'User Name',
  'LBL_DLIST_FIRSTNAME' => 'First Name',
  'LBL_DLIST_LASTNAME' => 'Last Name',
  'LBL_DLIST_EMAIL1' => 'e-mail',
  'LBL_DLIST_CONTACT_ID' => 'Contact ID',
  'LBL_DLIST_CONTACT_ACCOUNTNAME' => 'Account Name',
  'LBL_DLIST_CONTACT_ACCOUNTID' => 'Account ID',
  'LBL_DLIST_KREPORT_MODULENAME' => 'Module',
  'LBL_DLIST_WINDOW_ADDKREPORTS_TITLE' => 'Add KReports',
  'LBL_DLIST_WINDOW_ADDUSERS_TITLE' => 'Add Users',
  'LBL_DLIST_WINDOW_ADDCONTACTS_TITLE' => 'Add Contacts',
  'LBL_KSAVEDFILTERS' => 'Saved Filters',
  'LBL_KSAVEDFILTERS_ID' => 'Saved Filter ID',
  'LBL_KSAVEDFILTERS_NAME' => 'Name',
  'LBL_KSAVEDFILTERS_ASSIGNED_USER_ID' => 'Assigned User ID',
  'LBL_KSAVEDFILTERS_ASSIGNED_USER_NAME' => 'Assigned user',
  'LBL_KSAVEDFILTERS_IS_GLOBAL' => 'set for all users',
  'LBL_KSAVEDFILTERS_IS_GLOBAL_MARK' => '(G)',
  'LBL_KSAVEDFILTERS_SELECTEDFILTERS' => 'Filters',
  'LBL_KSAVEDFILTERS_SAVE_BTN' => 'Save Filters',
  'LBL_KSAVEDFILTERS_DELETE_BTN' => 'Delete',
  'LBL_KSAVESFILTERS_EMPTYTEXT' => '-- select a filter --',
  'LBL_KSAVEDFILTERS_WINDOW_TITLE' => 'Save Filter',
  'LBL_KSAVEDFILTERS_STATUS' => 'Status',
  'LBL_KSAVEDFILTERS_CONTENT' => 'Filter details',
  'LNK_MANAGE_CATEGORIES' => 'Manage Categories',
  'LNK_REPORT_COCKPIT' => 'KReporter Cockpit',
  'LBL_CATEGORIES_ID' => 'Category ID',
  'LBL_CATEGORIES_NAME' => 'Category name',
  'LBL_CATEGORIES_IS_ADMIN_ONLY' => 'Admin only',
  'LBL_CATEGORIES_PRIORITY' => 'Prio.',
  'LBL_ASSIGNED_CATEGORY_LABEL' => 'Cat.',
);