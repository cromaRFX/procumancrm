...
<script>
    ...
    {/literal}
</script>{literal}<script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['popup_query_form_reports_to_name_advanced']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["reports_to_name_advanced","reports_to_id_advanced"],"required_list":["reports_to_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects['popup_query_form_brch_branch_users_1_name_advanced']={"form":"popup_query_form","method":"query","modules":["brch_Branch"],"group":"or","field_list":["name","id"],"populate_list":["brch_branch_users_1_name_advanced","brch_branch_users_1brch_branch_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects['popup_query_form_department_master_c_advanced']={"form":"popup_query_form","method":"query","modules":["dprt_Departments"],"group":"or","field_list":["name","id"],"populate_list":["department_master_c_advanced","dprt_departments_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects['popup_query_form_cost_center_c_advanced']={"form":"popup_query_form","method":"query","modules":["costc_cost_center"],"group":"or","field_list":["name","id"],"populate_list":["cost_center_c_advanced","costc_cost_center_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>{/literal}