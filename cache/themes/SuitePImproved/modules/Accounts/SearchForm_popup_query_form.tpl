...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='vendor_id_c_advanced'>{sugar_translate label='LBL_VENDOR_ID' module='Accounts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.vendor_id_c_advanced.value) <= 0}
{assign var="value" value=$fields.vendor_id_c_advanced.default_value }
{else}
{assign var="value" value=$fields.vendor_id_c_advanced.value }
{/if}  
<input type='text' name='{$fields.vendor_id_c_advanced.name}' 
    id='{$fields.vendor_id_c_advanced.name}' size='30' 
    maxlength='80' 
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='shipping_address_city_advanced'>{sugar_translate label='LBL_SHIPPING_ADDRESS_CITY' module='Accounts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.shipping_address_city_advanced.value) <= 0}
{assign var="value" value=$fields.shipping_address_city_advanced.default_value }
{else}
{assign var="value" value=$fields.shipping_address_city_advanced.value }
{/if}  
<input type='text' name='{$fields.shipping_address_city_advanced.name}' 
    id='{$fields.shipping_address_city_advanced.name}' size='30' 
    maxlength='100' 
    value='{$value}' title=''  tabindex='-1'      >
                            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='shipping_address_state_advanced'>{sugar_translate label='LBL_SHIPPING_ADDRESS_STATE' module='Accounts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.shipping_address_state_advanced.value) <= 0}
{assign var="value" value=$fields.shipping_address_state_advanced.default_value }
{else}
{assign var="value" value=$fields.shipping_address_state_advanced.value }
{/if}  
<input type='text' name='{$fields.shipping_address_state_advanced.name}' 
    id='{$fields.shipping_address_state_advanced.name}' size='30' 
    maxlength='100' 
    value='{$value}' title=''  tabindex='-1'      >
                            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='shipping_address_postalcode_advanced'>{sugar_translate label='LBL_SHIPPING_ADDRESS_POSTALCODE' module='Accounts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.shipping_address_postalcode_advanced.value) <= 0}
{assign var="value" value=$fields.shipping_address_postalcode_advanced.default_value }
{else}
{assign var="value" value=$fields.shipping_address_postalcode_advanced.value }
{/if}  
<input type='text' name='{$fields.shipping_address_postalcode_advanced.name}' 
    id='{$fields.shipping_address_postalcode_advanced.name}' size='30' 
    maxlength='20' 
    value='{$value}' title=''  tabindex='-1'      >
                            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='shipping_address_country_advanced'>{sugar_translate label='LBL_SHIPPING_ADDRESS_COUNTRY' module='Accounts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.shipping_address_country_advanced.value) <= 0}
{assign var="value" value=$fields.shipping_address_country_advanced.default_value }
{else}
{assign var="value" value=$fields.shipping_address_country_advanced.value }
{/if}  
<input type='text' name='{$fields.shipping_address_country_advanced.name}' 
    id='{$fields.shipping_address_country_advanced.name}' size='30' 
