...
$manifest = array(
    ...
    'description' => 'Adds the capacity to create custom table and graphical reports',
    'author' => 'AlineaSol',
...
$installdefs = array(
	...
	'beans' => array(
	     array(
	     	'module'          => 'asol_Reports',
	     	'class'           => 'asol_Reports',
	     	'path'            => 'modules/asol_Reports/asol_Reports.php',
	     	'tab'             => true,
	     )
	),
	'entrypoints' => array (
	  0 => array (
	    'from' => '<basepath>/custom/entrypoints/asolReports_registry.php',
