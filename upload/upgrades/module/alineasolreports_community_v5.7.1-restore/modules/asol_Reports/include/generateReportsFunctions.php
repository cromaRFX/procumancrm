...
class asol_ReportsGenerationFunctions {
						...
						if (isset($nvd3)) {
							if ($getExportData) {
								...
								'<div class="asolChartContainer" engine="nvd3" style="height: '.($nvd3['dimensions']['height']+30).'px; width: '.$nvd3['dimensions']['width'].';" id="ASOLnvd3_'.$fixedReportId.'_'.$key.'">
									'.$nvd3['html'].'
									<svg xmlns="http://www.w3.org/2000/svg" id="ASOLsvg_'.$fixedReportId.'_'.$key.'" style="height: '.(($nvd3['dimensions']['height'] < 400) ? ($nvd3['dimensions']['height'] + 140) : ($nvd3['dimensions']['height'])).'px; width: '.$nvd3['dimensions']['width'].';direction:ltr;"></svg>
								</div>';
							}
						}
					}
	...
	static public function getReportDetailButtons($reportId, $isMetaReport, $isFilterVisible, $reportDomainId, $created_by, $assigned_user_id, $report_scope, $attachmentFormat, $sendEmailquestion, $scheduledTypeInfo, $filtersHiddenInputs, $searchCriteria, $isDashlet, $dashletId, $vardefFilters, $externalCall, $getLibraries, $overrideEntries, $scheduledEmailHideButtons, $displayNoDataMsg, $isWsExecution, $isPreview) {
		...
		if ((!$isDashlet) && (!$externalCall) && (!$filtersHiddenInputs) && (!$isPreview)) {
			...
			$returnedHTML .= '<button id="reportbutton_refresh" class="button" onclick="controllerReportDetail.reloadReport(\''.$reportId.'\', true, {\'dashlet\':'.($isDashlet ? 'true' : 'false').', \'dashletId\':\''.$dashletId.'\', \'metaDashletId\':\''.$metaDashletId.'\', \'currentUserId\':\''.$current_user->id.'\'});">'.asol_ReportsUtils::translateReportsLabel('LBL_REPORT_REFRESH').'</button>';
	...
	static public function getReportDetailPagination($reportId, $columnsCount, $externalCall, $getLibraries, $overrideEntries, $overrideData, $overrideConfig, $isDashlet, $dashletId, $numPages, $numPagesLabel, $pageNumber, $pageNumberLabel, $totalEntries, $sortField, $sortDirection, $sortIndex, $vardefFilters) {
						...
						<tbody>
							<tr>
								<td nowrap="nowrap" align="right" width="1%" class="paginationChangeButtons">
									<button '.$disabledPaginationButtonsBack.' title="'.$app_strings['LNK_LIST_START'].'" class="button paginationStart" type="button" onClick="controllerReportDetail.reloadReport(\''.$reportId.'\', false, {\'dashlet\':'.($isDashlet ? 'true' : 'false').', \'dashletId\':\''.$dashletId.'\', \'metaDashletId\':\''.$metaDashletId.'\', \'currentUserId\':\''.$current_user->id.'\', \'page_number\':\'0\', \'sort_field\':\''.$sortField.'\', \'sort_direction\':\''.$paginationSortDirection.'\', \'sort_index\':\''.$paginationSortIndex.'\', \'getLibraries\':\''.($isDashlet && $getLibraries ? 'true' : 'false').'\', \'overrideEntries\':'.(!empty($overrideEntries) ? '\''.$overrideEntries.'\'' : 'null').', \'overrideData\':'.(!empty($overrideData) ? '\''.urlencode(json_encode($overrideData)).'\'' : 'null').', \'overrideConfig\':'.(!empty($overrideConfig) ? '\''.urlencode(json_encode($overrideConfig)).'\'' : 'null').', \'vardefFilters\':'.(!empty($vardefFilters) ? '\''.$vardefFilters.'\'' : 'null').'});">
										<img height="11" border="0" align="absmiddle" width="13" alt="'.$app_strings['LNK_LIST_START'].'" src="'.$paginationStartImg.'">
									</button>
									<button '.$disabledPaginationButtonsBack.' title="'.$app_strings['LNK_LIST_PREVIOUS'].'" class="button paginationPrev" type="button"  onClick="controllerReportDetail.reloadReport(\''.$reportId.'\', false, {\'dashlet\':'.($isDashlet ? 'true' : 'false').', \'dashletId\':\''.$dashletId.'\', \'metaDashletId\':\''.$metaDashletId.'\', \'currentUserId\':\''.$current_user->id.'\', \'page_number\':\''.$previousPage.'\', \'sort_field\':\''.$sortField.'\', \'sort_direction\':\''.$paginationSortDirection.'\', \'sort_index\':\''.$paginationSortIndex.'\', \'getLibraries\':\''.($isDashlet && $getLibraries ? 'true' : 'false').'\', \'overrideEntries\':'.(!empty($overrideEntries) ? '\''.$overrideEntries.'\'' : 'null').', \'overrideData\':'.(!empty($overrideData) ? '\''.urlencode(json_encode($overrideData)).'\'' : 'null').', \'overrideConfig\':'.(!empty($overrideConfig) ? '\''.urlencode(json_encode($overrideConfig)).'\'' : 'null').', \'vardefFilters\':'.(!empty($vardefFilters) ? '\''.$vardefFilters.'\'' : 'null').'});">
										<img height="11" border="0" align="absmiddle" width="8" alt="'.$app_strings['LNK_LIST_PREVIOUS'].'" src="'.$paginationPreviousImg.'">
									</button>
									<span class="pageNumbers">'.asol_ReportsUtils::translateReportsLabel('LBL_REPORT_PAGINATION_PAGE', 'asol_Reports').' '.$pageNumberLabel.' '.asol_ReportsUtils::translateReportsLabel('LBL_REPORT_PAGINATION_OF', 'asol_Reports').' '.$numPagesLabel.'</span>
									<button '.$disabledPaginationButtonsForward.' title="'.$app_strings['LNK_LIST_NEXT'].'" class="button paginationNext" type="button" onClick="controllerReportDetail.reloadReport(\''.$reportId.'\', false, {\'dashlet\':'.($isDashlet ? 'true' : 'false').', \'dashletId\':\''.$dashletId.'\', \'metaDashletId\':\''.$metaDashletId.'\', \'currentUserId\':\''.$current_user->id.'\', \'page_number\':\''.$nextPage.'\', \'sort_field\':\''.$sortField.'\', \'sort_direction\':\''.$paginationSortDirection.'\', \'sort_index\':\''.$paginationSortIndex.'\', \'getLibraries\':\''.($isDashlet && $getLibraries ? 'true' : 'false').'\', \'overrideEntries\':'.(!empty($overrideEntries) ? '\''.$overrideEntries.'\'' : 'null').', \'overrideData\':'.(!empty($overrideData) ? '\''.urlencode(json_encode($overrideData)).'\'' : 'null').', \'overrideConfig\':'.(!empty($overrideConfig) ? '\''.urlencode(json_encode($overrideConfig)).'\'' : 'null').', \'vardefFilters\':'.(!empty($vardefFilters) ? '\''.$vardefFilters.'\'' : 'null').'});">
										<img height="11" border="0" align="absmiddle" width="8" alt="'.$app_strings['LNK_LIST_NEXT'].'" src="'.$paginationNextImg.'">
									</button>
									<button '.$disabledPaginationButtonsForward.' title="'.$app_strings['LNK_LIST_END'].'" class="button paginationEnd" type="button"  onClick="controllerReportDetail.reloadReport(\''.$reportId.'\', false, {\'dashlet\':'.($isDashlet ? 'true' : 'false').', \'dashletId\':\''.$dashletId.'\', \'metaDashletId\':\''.$metaDashletId.'\', \'currentUserId\':\''.$current_user->id.'\', \'page_number\':\''.$numPages.'\', \'sort_field\':\''.$sortField.'\', \'sort_direction\':\''.$paginationSortDirection.'\', \'sort_index\':\''.$paginationSortIndex.'\', \'getLibraries\':\''.($isDashlet && $getLibraries ? 'true' : 'false').'\', \'overrideEntries\':'.(!empty($overrideEntries) ? '\''.$overrideEntries.'\'' : 'null').', \'overrideData\':'.(!empty($overrideData) ? '\''.urlencode(json_encode($overrideData)).'\'' : 'null').', \'overrideConfig\':'.(!empty($overrideConfig) ? '\''.urlencode(json_encode($overrideConfig)).'\'' : 'null').', \'vardefFilters\':'.(!empty($vardefFilters) ? '\''.$vardefFilters.'\'' : 'null').'});">
	...
	static public function getReportDetailSearchCriteria($reportId, $filterVisibility, $filtersPanel, $filtersHiddenInputs, $external_filters, $searchCriteria, $currentUserId, $hasVardefFilter, $isDashlet, $dashletId, $cleanUpStyling, $filterslayoutConfig, $search_mode) {
		...
		<body>
			<div id="reportDiv" class="alineasol_reports">
				<span id="loadingContainer'.$dashletId.'" class="loadingContainer">
				    ...
				    <span class="loadingTEXT">'.($waitForReport ? $mod_strings['LBL_REPORT_WAITING'] : $mod_strings['LBL_REPORT_LOADING']).'</span>
				</span>
			</div>
		</body>';
	...
	public static function getLoadCurrentDashletScriptFunction($reportId, $isDashlet, $dashletId, $metaDashletId, $getLibraries, $vardefFilters, $overrideEntries, $currentUserId, $loginSession) {
		...
		return '
		function reloadCurrentDashletReport'.$fixedDashletId.'(refresh, pageNumber, sortField, sortDirection, sortIndex, externalParams, vardefFilters) {

			var postParameters = new Object();
			var isMetaReport = ((typeof window.hasPremiumReportsJsFeatures == "function") && window["isMetaReport'.$metaDashletId.'"]);
		...
		function loadCurrentDashletReport'.$fixedDashletId.'(refresh) {
			...
			controllerReportDetail.reloadReport("'.$reportId.'", refresh, {"dashlet":'.($isDashlet ? 'true' : 'false').', "dashletId":"'.$dashletId.'", "metaDashletId":"'.$metaDashletId.'", "isPreview":"'.($isPreview ? 'true' : 'false').'", "page_number":currentPage, "sort_field":currentSortField, "sort_direction":currentSortDirection, "sort_index":currentSortIndex, "overrideEntries":"'.$overrideEntries.'", "external_filters":externalFilters, "vardefFilters":"'.$vardefFilters.'"});
	...
	public static function manageExternalDatabaseQueries($alternativeDb, $reportModule, $simpleName = false) {
		...
		if ($alternativeDb !== false) {
			...
			$report_table = ($report_table == false ? BeanFactory::newBean($reportModule)->table_name : $report_table);
	...
	public static function buildExternalFilters($externalFilters, $vardefFilters, $userDateFormat) {
		...
		$jsonFilters = json_decode($externalFilters, true);
				...
				switch ($filterType) {
					...
					case "radioenum" :
						...
						if (in_array($filterEnumOperator, array('options', 'function'))) {
							...
							if (!$hasCustomEnum) {
								$opts = asol_Reports::getEnumValues($filterEnumOperator, $filterEnumReference);
								$optsLabels = asol_Reports::getEnumLabels($filterEnumOperator, $filterEnumReference);
							} else { 
						...
						if ($filterBehavior == "user_input") {
							...
							if (in_array($currentFilter['operator'], array("like", "not like", "starts with", "ends with"))) {
								$theInput1 = (!$hasCustomEnum) ? "<input type='text' id='".$filterReference.$fixedDashletId."_1' value='".$selectedOpts[0]."'>" : "<select id='".$filterReference."_1'>";
							} else {
						...
						switch ($currentFilter['operator']) {
								...
								switch ($currentFilter['parameters']['first'][0]) {
									...
									case "calendar":
										...
										if ($filterBehavior == "user_input") {
											...
											$theInput2 = "<input type='text' id='".$filterReference.$fixedDashletId."_2' class='calendarValue' value='".$date2."' readonly />";
											$theInput2 .= "<script type='text/javascript'> asolCalendar.initialize('detailContainer".$dashletId."', '".$filterReference.$fixedDashletId."_2', '".$date2."', null); </script>";
									...
									case "fiscalyear":
										...
										if ($filterBehavior == "user_input") {
											...
											$theInput1 = "<input type='hidden' id='".$filterReference.$fixedDashletId."_1' value='".$currentFilter['parameters']['first'][0]."'><span>".asol_ReportsUtils::translateReportsLabel($userInputLabel)."</span>";
											$theInput2 = "<input type='text' id='".$filterReference.$fixedDashletId."_2' style='width:80px' value='".$filterSecondParameter[0]."'>";
							...
							case "after date":
								...
								if ($filterBehavior == "user_input") {
									...
									$theInput1 = "<input type='text' id='".$filterReference.$fixedDashletId."_1_date' class='calendarValue' value='".$date1."' readonly />";
									$theInput1 .= "<script type='text/javascript'> asolCalendar.initialize('detailContainer".$dashletId."', '".$filterReference.$fixedDashletId."_1', '".$date1."', null); </script>";
								...
								switch ($currentFilter['parameters']['first'][0]) {
									...
									case "calendar":
										...
										if ($filterBehavior == "user_input") {
											...
											$theInput2 = "<input type='text' id='".$filterReference.$fixedDashletId."_2' class='calendarValue' value='".$input1."' readonly />";
											$theInput2 .= "<script type='text/javascript'> asolCalendar.initialize('detailContainer".$dashletId."', '".$filterReference.$fixedDashletId."_2', '".$input1."', null); </script>";
											$theInput3 = "<input type='text' id='".$filterReference.$fixedDashletId."_3' class='calendarValue' value='".$input2."' readonly />";
											$theInput3 .= "<script type='text/javascript'> asolCalendar.initialize('detailContainer".$dashletId."', '".$filterReference.$fixedDashletId."_3', '".$input2."', null); </script>";
									...
									case "fiscalyear":
										...
										if ($filterBehavior == "user_input") {
											...
											$theInput1 = "<input type='hidden' id='".$filterReference.$fixedDashletId."_1' value='".$currentFilter['parameters']['first'][0]."'><span>".asol_ReportsUtils::translateReportsLabel($userInputLabel)."</span>";
											$theInput2 = "<input type='text' id='".$filterReference.$fixedDashletId."_2' style='width:80px' value='".$input1."'>";
											$theInput3 = "<span style='display: block'>".asol_ReportsUtils::translateReportsLabel('LBL_REPORT_AND')."</span>";
											$theInput3 .= "<input type='text' id='".$filterReference.$fixedDashletId."_3' style='width:80px' value='".$input2."'>";
							...
							case "not last":
								...
								switch ($currentFilter['parameters']['first'][0]) {
									...
									case "Fyear":
										...
										if ($filterBehavior == "user_input")
											$theInput2 = '<input id="'.$filterReference.$fixedDashletId.'_2" type="text" value="'.$filterSecondParameter[0].'">';
										else if ($filterBehavior == "visible")
											$theInput2 = '<span>'.$filterSecondParameter[0].'</span>';
									...
									default:
										...
										if ($filterBehavior == "user_input")
											$theInput2 = '<input id="'.$filterReference.$fixedDashletId.'_2" style="display: none;" type="text" value="'.$filterSecondParameter[0].'">';
										else if ($filterBehavior == "visible")
											$theInput2 = '<span>'.$filterSecondParameter[0].'</span>';
					...
					case "relate" :
						...
						<button type='button' class='button' onclick=\"open_popup('".$relateModule."', 600, 400, '', true, false, {'call_back_function':'set_return','form_name':'criteria_form','field_to_name_array':{'".$relateId."':'".$fieldInputId."','".$relateName."':'".$fieldInputName."'}}, 'single', true);\" title='".$app_strings['LBL_SELECT_BUTTON_LABEL']."'><img src='themes/default/images/id-ff-select.png'></button>
						<button type='button' class='button' onclick=\"document.getElementById('".$filterReference.$fixedDashletId."_1_name').value =''; document.getElementById('".$filterReference.$fixedDashletId."_1').value = ''\" value='".$app_strings['LBL_CLEAR_BUTTON_LABEL']."'><img src='themes/default/images/id-ff-clear.png'></button>";
					...
					default:
						...
						if ($filterBehavior == "user_input") {
							...
							if (!$hasCustomEnum) {
								...
								$theInput1 = '<input id="'.$filterReference.$fixedDashletId.'_1" type="text" value="'.$currentFilter['parameters']['first'][0].'">';
		...
		if ($fileType == 'app') {
			...
			switch ($reportAttachmentFormat) {
				...
				case "HTML":
					...
					$attachment = generateFile($reportAttachmentConfig, $report_name, $report_module, $description, $displayTitles, $displayHeaders, $columns, $rsExport, $rsExportNoFormat, $totals, $rsTotals, $subTotalsExport, $isDetailedReport, $isGroupedReport, $hasGroupedTotalBelowColumn, $pdf_orientation, $pngs, $legends, $engines, true, 100, $fileTime, $userTZ, $row_index_display, $report_charts, $columnsDataTypes, $columnsDataFunctions, $columnsDataVisible, $columnsDataWidths, $currentReportCss, $contextDomainId,$pdf_pageFormat);
					break;
				...
				case "PDF":
					...
					$attachment = generateFile($reportAttachmentConfig, $report_name, $report_module, $description, $displayTitles, $displayHeaders, $columns, $rsExport, $rsExportNoFormat, $totals, $rsTotals, $subTotalsExport, $isDetailedReport, $isGroupedReport, $hasGroupedTotalBelowColumn, $pdf_orientation, $pngSrcs, $legends, $engines, false, $pdf_img_scaling_factor, $fileTime, $userTZ, $row_index_display, $report_charts, $columnsDataTypes, $columnsDataFunctions, $columnsDataVisible, $columnsDataWidths, $currentReportCss, $contextDomainId,$pdf_pageFormat);
					break;
						
				case "CSV":
					$attachment = generateCsv($reportAttachmentConfig, $report_name, $columns, $rsExport, $rsExportNoFormat, $totals, $rsTotals, $subTotalsExport, $isDetailedReport, $isGroupedReport, $hasGroupedTotalBelowColumn, false, $row_index_display, $columnsDataTypes, $columnsDataVisible, false, !$displayTitles, !$displayHeaders);
					break;
						
				case "CSVC":
					$attachment = generateCsv($reportAttachmentConfig, $report_name, $columns, $rsExport, $rsExportNoFormat, $totals, $rsTotals, $subTotalsExport, $isDetailedReport, $isGroupedReport, $hasGroupedTotalBelowColumn, false, $row_index_display, $columnsDataTypes, $columnsDataVisible, true, true, false, false, true);
					break;
						
				case "XLS":
					$attachment = generateXls($reportAttachmentConfig, $report_name, $columns, $rsExport, $rsExportNoFormat, $totals, $rsTotals, $subTotalsExport, $isDetailedReport, $isGroupedReport, $hasGroupedTotalBelowColumn, false, $row_index_display, $columnsDataTypes, $columnsDataVisible, false, !$displayTitles, !$displayHeaders);
					break;
						
				case "XLSC":
					$attachment = generateXls($reportAttachmentConfig, $report_name, $columns, $rsExport, $rsExportNoFormat, $totals, $rsTotals, $subTotalsExport, $isDetailedReport, $isGroupedReport, $hasGroupedTotalBelowColumn, false, $row_index_display, $columnsDataTypes, $columnsDataVisible, true, true, false, true, true);
					break;
			...
			if ($fileType == 'csv') {
				...
				$filePath = generateCsv($reportAttachmentConfig, $report_name , $columns, $rsExport, $rsExportNoFormat, $totals, $rsTotals, $subTotalsExport, $isDetailedReport, $isGroupedReport, $hasGroupedTotalBelowColumn, false, $row_index_display, $columnsDataTypes, $columnsDataVisible, false, !$displayTitles, !$displayHeaders);
				
			} else if ($fileType == 'csvc') {
	
				$filePath = generateCsv($reportAttachmentConfig, $report_name , $columns, $rsExport, $rsExportNoFormat, $totals, $rsTotals, $subTotalsExport, $isDetailedReport, $isGroupedReport, $hasGroupedTotalBelowColumn, false, $row_index_display, $columnsDataTypes, $columnsDataVisible, true, true, false, false, true);
				
			} else if ($fileType == 'xls') {
	
				$filePath = generateXls($reportAttachmentConfig, $report_name, $columns, $rsExport, $rsExportNoFormat, $totals, $rsTotals, $subTotalsExport, $isDetailedReport, $isGroupedReport, $hasGroupedTotalBelowColumn, false, $row_index_display, $columnsDataTypes, $columnsDataVisible, false, !$displayTitles, !$displayHeaders);
				
			} else if ($fileType == 'xlsc') {
	
				$filePath = generateXls($reportAttachmentConfig, $report_name, $columns, $rsExport, $rsExportNoFormat, $totals, $rsTotals, $subTotalsExport, $isDetailedReport, $isGroupedReport, $hasGroupedTotalBelowColumn, false, $row_index_display, $columnsDataTypes, $columnsDataVisible, true, true, false, true, true);
				...
				$filePath = generateFile($reportAttachmentConfig, $report_name , $report_module, $description, $displayTitles, $displayHeaders, $columns, $rsExport, $rsExportNoFormat, $totals, $rsTotals, $subTotalsExport, $isDetailedReport, $isGroupedReport, $hasGroupedTotalBelowColumn, $pdf_orientation, $pngSrcs, $legends, $engines, true, 100, $fileTime, $userTZ, $row_index_display, $report_charts, $columnsDataTypes, $columnsDataFunctions, $columnsDataVisible, $columnsDataWidths, $currentReportCss, $contextDomainId,$pdf_pageFormat);
