...
$app_list_strings['rfxa_rfx_answer_category_dom']['Marketing'] = 'Маркетинг';
$app_list_strings['rfxa_rfx_answer_category_dom']['Knowledege Base'] = 'База знаний';
$app_list_strings['rfxa_rfx_answer_category_dom']['Sales'] = 'Продажи';
$app_list_strings['rfxa_rfx_answer_subcategory_dom'][''] = '';
$app_list_strings['rfxa_rfx_answer_subcategory_dom']['Marketing Collateral'] = 'Маркетинг';
$app_list_strings['rfxa_rfx_answer_subcategory_dom']['Product Brochures'] = 'Брошюры товаров';
$app_list_strings['rfxa_rfx_answer_subcategory_dom']['FAQ'] = 'ЧаВо';
$app_list_strings['rfxa_rfx_answer_status_dom']['Active'] = 'Активен';
$app_list_strings['rfxa_rfx_answer_status_dom']['Draft'] = 'Черновик';
$app_list_strings['rfxa_rfx_answer_status_dom']['FAQ'] = 'ЧаВо';
$app_list_strings['rfxa_rfx_answer_status_dom']['Expired'] = 'Просрочен';
$app_list_strings['rfxa_rfx_answer_status_dom']['Under Review'] = 'Рассматривается';
$app_list_strings['rfxa_rfx_answer_status_dom']['Pending'] = 'Ожидание решения';
...
$app_list_strings['brch_branch_type_dom']['Provider'] = 'Поставщик';
$app_list_strings['brch_branch_type_dom']['Delivery service'] = 'Служба доставки';
$app_list_strings['brch_branch_type_dom'][''] = '';
$app_list_strings['brch_branch_type_dom']['Analyst'] = 'Аналитик';
$app_list_strings['brch_branch_type_dom']['Competitor'] = 'Конкурент';
$app_list_strings['brch_branch_type_dom']['Customer'] = 'Клиент';
$app_list_strings['brch_branch_type_dom']['Integrator'] = 'Интегратор';
$app_list_strings['brch_branch_type_dom']['Investor'] = 'Инвестор';
$app_list_strings['brch_branch_type_dom']['Partner'] = 'Партнер';
$app_list_strings['brch_branch_type_dom']['Press'] = 'Пресса';
$app_list_strings['brch_branch_type_dom']['Prospect'] = 'Адресат';
$app_list_strings['brch_branch_type_dom']['Reseller'] = 'Реселлер';
$app_list_strings['brch_branch_type_dom']['Other'] = 'Другое';
...
$app_list_strings['ctmr_customers_type_dom']['Provider'] = 'Поставщик';
$app_list_strings['ctmr_customers_type_dom']['Delivery service'] = 'Служба доставки';
$app_list_strings['ctmr_customers_type_dom'][''] = '';
$app_list_strings['ctmr_customers_type_dom']['Analyst'] = 'Аналитик';
$app_list_strings['ctmr_customers_type_dom']['Competitor'] = 'Конкурент';
$app_list_strings['ctmr_customers_type_dom']['Customer'] = 'Клиент';
$app_list_strings['ctmr_customers_type_dom']['Integrator'] = 'Интегратор';
$app_list_strings['ctmr_customers_type_dom']['Investor'] = 'Инвестор';
$app_list_strings['ctmr_customers_type_dom']['Partner'] = 'Партнер';
$app_list_strings['ctmr_customers_type_dom']['Press'] = 'Пресса';
$app_list_strings['ctmr_customers_type_dom']['Prospect'] = 'Адресат';
$app_list_strings['ctmr_customers_type_dom']['Reseller'] = 'Реселлер';
$app_list_strings['ctmr_customers_type_dom']['Other'] = 'Другое';
$app_list_strings['_type_dom'][''] = '';
$app_list_strings['_type_dom']['Analyst'] = 'Analista';
$app_list_strings['_type_dom']['Competitor'] = 'Competidor';
$app_list_strings['_type_dom']['Customer'] = 'Cliente';
