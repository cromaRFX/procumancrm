 ...
 * PLACE ANY CUSTOMIZATIONS IN brch_Branch
 */

require_once('include/SugarObjects/templates/company/Company.php');

class brch_Branch_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'brch_Branch';
	var $object_name = 'brch_Branch';
	var $table_name = 'brch_branch';
