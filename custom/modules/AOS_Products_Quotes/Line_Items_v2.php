        ...
        while ($row = $focus->db->fetchByAssoc($result)) {
            ...
            if($line_item->product_id != '0' && $line_item->product_id != null){
                ...
                if($serviceCount == 0)
                {
                    ...
                    $service .= "<td width='46%' class='dataLabel' style='text-align: left;padding:2px;' colspan='3' scope='row'>".$mod_strings['LBL_SERVICE_NAME']."</td>";
                ...
                $service .= "<td class='tabDetailViewDF' style='padding:2px;' colspan='3'>".$line_item->name."</td>";
