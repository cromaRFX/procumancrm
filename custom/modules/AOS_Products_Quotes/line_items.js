...
function insertLineItems(product,group){
    ...
    for(var p in product){
        if(document.getElementById(type + p + ln) !== null){
            /*For ahi_c Checkbox*/
            if (p == 'ahi_c' && product[p] == 1) {
                document.getElementById(type + p + ln).setAttribute("checked", true);
            }
            /*For ahi_c Checkbox*/
...
function insertProductLine(tableid, groupid) {
    ...
    sqs_objects["product_name[" + prodln + "]"] = {
        ...
        "group": "or",
        "field_list": ["name", "id","part_number", "cost", "price","description","currency_id","size_c","color_c",'supplier_name_c'],
        "populate_list": ["product_name[" + prodln + "]", "product_product_id[" + prodln + "]", "product_part_number[" + prodln + "]", "product_product_cost_price[" + prodln + "]", "product_product_list_price[" + prodln + "]", "product_item_description[" + prodln + "]", "product_currency[" + prodln + "]", "product_size_c[" + prodln + "]","product_color_c[" + prodln + "]","product_supplier_name_c[" + prodln + "]"],
    ...
    sqs_objects["product_part_number[" + prodln + "]"] = {
        ...
        "modules": ["AOS_Products"],
        "group": "or",
        "field_list": ["part_number", "name", "id","cost", "price","description","currency_id","size_c","color_c","supplier_name_c"],
        "populate_list": ["product_part_number[" + prodln + "]", "product_name[" + prodln + "]", "product_product_id[" + prodln + "]",  "product_product_cost_price[" + prodln + "]", "product_product_list_price[" + prodln + "]", "product_item_description[" + prodln + "]","product_currency[" + prodln + "]","product_size_c[" + prodln + "]","product_color_c[" + prodln + "]","product_supplier_name_c[" + prodln + "]"],
        "required_list": ["product_id[" + prodln + "]"],
        "conditions": [{
            "name": "part_number",
            "op": "like_custom",
    ...
    a.innerHTML = "<input type='text' style='' name='product_product_qty[" + prodln + "]' id='product_product_qty" + prodln + "' size='5' value='' title='' tabindex='116' onblur='Quantity_format2Number(" + prodln + ");calculateLine(" + prodln + ",\"product_\");'>";

    var b = x.insertCell(1);
    b.innerHTML = "<input style='margin-bottom:8px; width:90px;' class='sqsEnabled' autocomplete='off' type='text' name='product_name[" + prodln + "]' id='product_name" + prodln + "' maxlength='50' value='' title='' tabindex='116' value=''><input type='hidden' name='product_product_id[" + prodln + "]' id='product_product_id" + prodln + "' size='20' maxlength='50' value=''>";

    var b1 = x.insertCell(2);
    b1.innerHTML = "<input style=' margin-bottom:8px; width:90px;' class='sqsEnabled' autocomplete='off' type='text' name='product_part_number[" + prodln + "]' id='product_part_number" + prodln + "' maxlength='50' value='' title='' tabindex='116' value=''>";
    ...
    c.innerHTML = "<input style='text-align: right;' type='text' name='product_product_list_price[" + prodln + "]' id='product_product_list_price" + prodln + "' size='11' maxlength='50' value='' title='' tabindex='116' onblur='calculateLine(" + prodln + ",\"product_\");'><input type='hidden' name='product_product_cost_price[" + prodln + "]' id='product_product_cost_price" + prodln + "' value=''  />";
...
function openProductPopup(ln){
    ...
    var popupRequestData = {
        ...
        "field_to_name_array" : {
            ...
            "accounts_aos_products_1_name" : "product_supplier_name_c" + ln
        }
    };
...
function openServicePopup_Assets(ln){
    ...
    var popupRequestData = {
        ...
        "form_name" : "EditView",
        "field_to_name_array" : {
            "id" : "service_assets_id_c" + ln,
            "name" : "service_asset_name_c" + ln,
        }
    };
...
function openServicePopup_BudgetCode(ln){
    ...
    var popupRequestData = {
        ...
        "form_name" : "EditView",
        "field_to_name_array" : {
            "id" : "service_budget_code_id_c" + ln,
            "name" : "service_budget_code_name_c" + ln,
        }
    };
...
function ahi_function(ln)
{
    var ahi_checkbox = document.getElementById('service_ahi_c'+ ln);
    if (ahi_checkbox.checked == true)
    {
        // alert("Box is checked");
        ahi_checkbox.setAttribute("checked", true);
        ahi_checkbox.setAttribute("value", '1');
    }
    else
    {
        // alert("Box is unchecked");
        ahi_checkbox.removeAttribute("checked");
        ahi_checkbox.setAttribute("value", '0');
    }
}
/*usman*/
...
function insertServiceLine(tableid, groupid) {
    ...
    var a = x.insertCell(0);
    a.colSpan = "2";
    a.innerHTML = "<textarea style='width:260px;' name='service_name[" + servln + "]' id='service_name" + servln + "' size='16' cols='64' title='' tabindex='116'></textarea><input type='hidden' name='service_product_id[" + servln + "]' id='service_product_id" + servln + "' size='20' maxlength='50' value='0'>";
    ...
    var a3 = x.insertCell(4);
    a3.innerHTML = "<input type='text' style='text-align: right; width:70px;' name='service_product_discount[" + servln + "]' id='service_product_discount" + servln + "' size='8' maxlength='50' value='' title='' tabindex='116' onblur='calculateLine(" + servln + ",\"service_\");' onblur='calculateLine(" + servln + ",\"service_\");'><input type='hidden' name='service_product_discount_amount[" + servln + "]' id='service_product_discount_amount" + servln + "' value=''  />";
    a3.innerHTML += "<select tabindex='116' name='service_discount[" + servln + "]' id='service_discount" + servln + "' onchange='calculateLine(" + servln + ",\"service_\");'>" + discount_hidden + "</select>";

    var b = x.insertCell(5);
    b.innerHTML = "<input type='text' style='text-align: right;' name='service_product_unit_price[" + servln + "]' id='service_product_unit_price" + servln + "' size='11' maxlength='50' value='' title='' tabindex='116'   onblur='calculateLine(" + servln + ",\"service_\");'>";
    ...
    e.innerHTML = "<input type='text' style='text-align: right;' name='service_product_total_price[" + servln + "]' id='service_product_total_price" + servln + "' size='11' maxlength='50' value='' title='' tabindex='116' readonly='readonly'><input type='hidden' name='service_group_number[" + servln + "]' id='service_group_number" + servln + "' value='"+ groupid +"'>";
    ...
    y1.colSpan = '1';
    y1.innerHTML = "<span>"  + SUGAR.language.get(module_sugar_grp1, 'LBL_ITEM_CODE_C') + " :&nbsp;</span>";
    y1.innerHTML += "<input style='width: 60px;'type='text' style='text-align: right;' name='service_item_code_c[" + servln + "]' id='service_item_code_c" + servln + "' size='8' maxlength='20' value='' title='' tabindex='116'>";
    ...
    y3.innerHTML = "<span>"  +SUGAR.language.get(module_sugar_grp1, 'LBL_UNIT_OF_MEASURE_C')+": &nbsp; </span>" +"<select tabindex='116' name='service_unit_of_measure_c[" + servln + "]' id='service_unit_of_measure_c" + servln + "' >" + unit_of_measure_c + "</select>";

    var y4 = y.insertCell(3);
    y4.innerHTML = "<span>"  +SUGAR.language.get(module_sugar_grp1, 'LBL_COST_CENTER_C') +": &nbsp; </span>" +"<input style='width: 60px;' type='text' style='text-align: left;' class='sqsEnabled' autocomplete='off' name='service_cost_center_name_c[" + servln + "]' id='service_cost_center_name_c" + servln + "' size='8' maxlength='20' value='' title='' tabindex='116' ><input type='hidden' name='service_cost_center_id_c[" + servln + "]' id='service_cost_center_id_c" + servln + "' size='20' maxlength='50' value=''>";
    y4.innerHTML += "<button title='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_TITLE') + "' accessKey='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_KEY') + "' type='button' tabindex='116' class='button' value='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_LABEL') + "' name='btn3' onclick='openServicePopup_CostCenter(" + servln + ");'><img src='themes/default/images/id-ff-select.png' alt='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_LABEL') + "'></button>";

    var y5 = y.insertCell(4);
    y5.innerHTML = "<span>"  +SUGAR.language.get(module_sugar_grp1, 'LBL_BUDGET_CODE_C')+": &nbsp; </span>" +"<input style='width: 60px;' type='text' style='text-align: right;'class='sqsEnabled' autocomplete='off' name='service_budget_code_name_c[" + servln + "]' id='service_budget_code_name_c" + servln + "' size='8' maxlength='20' value='' title='' tabindex='116' ><input type='hidden' name='service_budget_code_id_c[" + servln + "]' id='service_budget_code_id_c" + servln + "' size='20' maxlength='50' value=''>";
    y5.innerHTML += "<button title='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_TITLE') + "' accessKey='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_KEY') + "' type='button' tabindex='116' class='button' value='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_LABEL') + "' name='btn4' onclick='openServicePopup_BudgetCode(" + servln + ");'><img src='themes/default/images/id-ff-select.png' alt='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_LABEL') + "'></button>";

    var y6 = y.insertCell(5);
    y6.innerHTML =  "<span>"  +SUGAR.language.get(module_sugar_grp1, 'LBL_DELIVERY_CODE_C')+": &nbsp; </span>"+"<input style='width: 60px;' type='text' style='text-align: right;' class='sqsEnabled' autocomplete='off' name='service_delivery_to_name_c[" + servln + "]' id='service_delivery_to_name_c" + servln + "' size='8' maxlength='20' value='' title='' tabindex='116' ><input type='hidden' name='service_delivery_to_id_c[" + servln + "]' id='service_delivery_to_id_c" + servln + "' size='20' maxlength='50' value=''>";
    y6.innerHTML += "<button title='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_TITLE') + "' accessKey='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_KEY') + "' type='button' tabindex='116' class='button' value='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_LABEL') + "' name='btn5' onclick='openServicePopup_Delivery(" + servln + ");'><img src='themes/default/images/id-ff-select.png' alt='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_LABEL') + "'></button>";

    var y7 = y.insertCell(6);
    y7.innerHTML ="<span>"  + SUGAR.language.get(module_sugar_grp1, 'LBL_AHI_C')+": &nbsp; </span>" +"<input type='checkbox' value='1.0' class='checkbox' name='service_ahi_c[" + servln + "]' id='service_ahi_c" + servln + "' tabindex='117' onclick='ahi_function(" + servln + ");'>";

    enableQS(true);

    var z = tablebody.insertRow(-1);
    z.id = 'service_line' + servln;

    var z1 = z.insertCell(0);
    z1.colSpan = '2';
    z1.innerHTML = "<span>"  + SUGAR.language.get(module_sugar_grp1, 'LBL_SERVICE_NOTE_C')+": &nbsp; </span>" +"<textarea style='text-align: right; width:200px;' name='service_note_c[" + servln + "]' id='service_note_c" + servln + "' value='' title='' rows='2' cols='23' tabindex='116'>";

    var z2 = z.insertCell(1);
    z2.innerHTML = "<span>"  + SUGAR.language.get(module_sugar_grp1, 'LBL_SAP_PO_NO_C')+": &nbsp; </span>" +"<input type='text' style='text-align: right; width:110px;' name='service_sap_po_no_c[" + servln + "]' id='service_sap_po_no_c" + servln + "' value='' title='' tabindex='116'>";

    var z3 = z.insertCell(2);
...
function insertServiceHeader(tableid){
    ...
    var b=x.insertCell(1);
    b.style.color="rgb(68,68,68)";
    b.innerHTML=SUGAR.language.get(module_sugar_grp1, 'LBL_SERVICE_QTY_C');

    var i=x.insertCell(2);
    i.style.color="rgb(68,68,68)";
    i.innerHTML=SUGAR.language.get(module_sugar_grp1, 'LBL_PAYMENT_TERM_C');

    var c=x.insertCell(3);
    c.style.color="rgb(68,68,68)";
    c.innerHTML=SUGAR.language.get(module_sugar_grp1, 'LBL_SERVICE_LIST_PRICE');

    var d=x.insertCell(4);
    d.style.color="rgb(68,68,68)";
    d.innerHTML=SUGAR.language.get(module_sugar_grp1, 'LBL_SERVICE_DISCOUNT');
...
function calculateLine(ln, key){
    ...
    if(document.getElementById(key + 'product_qty' + ln) !== null){
        ...
        if(key=='product_')
            ...
            customQuantity_format2Number(ln);
    }
...
function customQuantity_format2Number(ln)
{
    var str = '';
    var qty=unformat2Number(document.getElementById('service_product_qty' + ln).value);
    if(qty === null){qty = 1;}
    ...
    document.getElementById('service_product_qty' + ln).value=str;
    //debugger;
}
...
function checkSuppliers(){
    var supplierName=$('#billing_account').val();
    var flag="true";
    if(supplierName){
        $('input[id^="product_supplier_name_c"]:visible').each(function () {
            if(supplierName==this.value){
        ...
        if(flag=='true')
            ...
            YAHOO.SUGAR.MessageBox.show({msg: 'Please, select products from single supplier only', title: 'Error'} );
            return false;
        }
    }
    else{
