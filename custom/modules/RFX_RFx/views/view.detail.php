...
//formLetter::DVPopupHtml('RFX_RFx');

require_once('include/MVC/View/views/view.detail.php');

class RFX_RFxViewDetail extends ViewDetail {
	function RFX_RFxViewDetail(){
 		parent::ViewDetail();
 	}
	
	function display(){
		$this->populateRFxTemplates();
		$this->displayPopupHtml();
		parent::display();
	}
	
	function populateRFxTemplates(){
		global $app_list_strings, $current_user;
		
		$sql = "SELECT id, name FROM aos_pdf_templates WHERE deleted=0 AND type='RFX_RFx' AND active = 1";
