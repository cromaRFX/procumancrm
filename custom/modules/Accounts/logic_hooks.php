...
$hook_array['before_save'][] = Array(1, 'Products Trade License Expiry Date', 'custom/modules/Accounts/Account_LogicHooks.php','Account_LogicHooks', 'setProductsTradeLicenseExpiryDate'); 
