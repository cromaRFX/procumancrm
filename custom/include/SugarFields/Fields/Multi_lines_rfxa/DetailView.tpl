...
<table width="100%" border="0" cellspacing="1" cellpadding="0" id="{$module}__table__{$multi_lines_count}" class="yui3-skin-sam edit view panelContainer" data-index_num="0">
  <tbody>
    ...
    <tr>
      <td valign="top" id="{$module}__line_item_price__{$multi_lines_count}_label" width="12%" scope="col"> {$APP.LBL_MULTI_RFX_LINES_PRICE}: </td>
      ...
      <td valign="top" id="{$module}__line_item_qty__{$multi_lines_count}_label" width="12%" scope="col"> {$APP.LBL_MULTI_RFX_LINES_QUANTITY}: </td>
