...
{{* 
Este é um código customizado que você pode definir para exibir uma segunda coluna da tabela de endereços.
Um exemplo poderia ser o botão "Copiar" presente na visualização detalhada de Contas.
Veja modules/Accounts/views/view.detail.php para ver o valor sendo definido.
*}}
