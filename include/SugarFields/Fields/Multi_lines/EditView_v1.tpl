	...
	function addMultiLineRow()
	{
	  ...
	  */
		YAHOO.util.Event.addListener('porq_Purchase_Request__line_item_price__'+cur_count, 'change', function(){
				...
				$('#porq_Purchase_Request__line_item_cost__'+rowNum).val( parseFloat(this.value*$('#porq_Purchase_Request__line_item_qty__'+rowNum).val() ).toFixed(2) );
