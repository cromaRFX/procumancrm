  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="0" id="{$module}__table__{$multi_lines_count}" class="edit" data-index_num="0">
    <tbody>
      ...
      <tr>
        ...
        <td valign="top"><input type="text" name="{$module}__line_item_supplier_name[{$multi_lines_count}]" class="sqsEnabled yui-ac-input" tabindex="0" id="{$module}__line_item_supplier_name__{$multi_lines_count}" size="18" value="{$item.5}" title="" autocomplete="off">
...
SUGAR.util.doWhen(
      ...
      <tr>
        ...
        <td valign="top"><input type="text" name="{$module}__line_item_product_name[{$multi_lines_count}]" class="sqsEnabled yui-ac-input" tabindex="0" id="{$module}__line_item_product_name__{$multi_lines_count}" size="18" value="{$item.7}" title="" autocomplete="off">
