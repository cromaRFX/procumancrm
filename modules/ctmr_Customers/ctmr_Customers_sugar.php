 ...
 * PLACE ANY CUSTOMIZATIONS IN ctmr_Customers
 */

require_once('include/SugarObjects/templates/company/Company.php');

class ctmr_Customers_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'ctmr_Customers';
	var $object_name = 'ctmr_Customers';
	var $table_name = 'ctmr_customers';
	var $importable = true;
