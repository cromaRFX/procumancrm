...
<tr>
	<td class='mbLBL'>{sugar_translate module="DynamicFields" label="COLUMN_TITLE_DEFAULT_VALUE"}:</td><td>
	    {sugar_translate module="DynamicFields" label="MULTILINES_IS_BY_DEFAULT"}
	</td>
</tr>
...
<tr>
    ...
    <td>
    	{sugar_translate module="DynamicFields" label="MULTILINES_IS_NOT_REPORTABLE"}
...
<tr>
    ...
    <td>
       {sugar_translate module="DynamicFields" label="MULTILINES_IS_NOT_IMPORTABLE"}
    </td>
</tr>
...
<tr>
    ...
    <td>
        {sugar_translate module="DynamicFields" label="MULTILINES_IS_NOT_MERGEABLE"}
    </td>
</tr>
</table>