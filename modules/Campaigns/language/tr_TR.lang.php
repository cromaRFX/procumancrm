...
$mod_strings = array (
  'LBL_FROM_ADDR' => 'E-posta adresinden: ',
  ...
  'LBL_CAMPAIGN_INACTIVE_SCHEDULE' => "'{0}' Kampanyasının durumu \"Pasif\". Kampanyanın durumunu \"Aktif\" hale getirmelisiniz.",
  ...
  'ERR_SENDING_NOW'=>'İletiler alınıyor, daha sonra deneyin.',
  ...
  'LBL_DEFAULT_LIST_NOT_FOUND'=>'Hedef türü varsayılan listesi bulunamadı',
  ...
  'LBL_EDIT_OPT_OUT_'=>'Devre dışı bağlantı?',
  ...
  //web to lead wizard titles
    ...
    'LBL_TOP_CAMPAIGNS_DESCRIPTION' => 'Gelir Açısından En Başarılı Kampanyalar',
    ...
    'ERR_NO_OPTS_SAVED'		=> 'Hiçbir optimal değer gelen e-posta hesabınızla kaydedilmedi.',
    'ERR_REVIEW_EMAIL_SETTINGS' => ' Lütfen ayarları gözden geçirin',
    'LBL_LEADS_DELETED_SINCE_CREATED' => 'Bu kampanya başladğından itibaren, kampanya süresince oluşturulan {0} potansiyel silindi.',
);
