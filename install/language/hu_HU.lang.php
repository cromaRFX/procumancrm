...
$mod_strings = array(
	'LBL_BASIC_SEARCH'					=> 'Alap',
	'LBL_ADVANCED_SEARCH'				=> 'Haladó',
	'LBL_BASIC_TYPE'					=> 'Alap típusú',
	...
	'LBL_SYSOPTS_CONFIG'				=> 'Rendszer beállítás',
	'LBL_SYSOPTS_DB_TYPE'				=> '',
	...
	'LBL_MAKE_DIRECTORY_WRITABLE'      => 'Kérjük, a következő könyvtárat írásjogokkal ruházza fel:',
    ...
    'ERR_CHECKSYS_CALL_TIME'            => 'Call time pass referenciát állítsa ON-ra ( a php.ini file-ban)',
	...
	'ERR_CHECKSYS_MSSQL_MQGPC'			=> '"Magic Quotes GPC" nem kapcsolható "On"-ra MS SQL Server használatakor.',
	...
	'ERR_CHECKSYS_MYSQL_VERSION'		=> 'Minimum verzió 4.1.2 - található: ',
	'ERR_CHECKSYS_NO_SESSIONS'			=> 'Nem sikerült írni és olvasni a session változókat. A telepítés nem folytatható.',
	'ERR_CHECKSYS_NOT_VALID_DIR'		=> 'Nem érvényes könyvtár',
	'ERR_CHECKSYS_NOT_WRITABLE'			=> 'Figyelmeztetés: Nem írható',
	'ERR_CHECKSYS_PHP_INVALID_VER'		=> 'Az ön PHP verziója nem támogatja a CRM szoftver futását. A kompatibilis változat telepítéséhez kérem olvassa el a KompatibilitásMátrix leírást! És annak megfelelően telepítse újra a PHP futttató környezetet!',
    ...
    'ERR_CHECKSYS_PHP_UNSUPPORTED'		=> 'Nem támogatott PHP verzió van telepítve. (verzió',
    ...
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE'  => 'A config felülírható fájl létezik, de nem írható.  Kérjük, tegye meg a szükséges lépéseket, hogy a fájl írható legyen.  Operációs rendszertől függően szükséges lehet a jogosultságokon változtatni (chmod 766), vagy jobb kattintás - tulajdonságoknál Windows esetében  törölje a csak olvasható lehetőséget.',
	...
	'LBL_CHECKSYS_CONFIG_OVERRIDE'		=> 'Írható CRM konfigurációs fájl (config_override.php)',
    ...
    'LBL_FTS'                           => 'Teljes szöveges keresés',
    'LBL_FTS_INSTALLED'                 => 'Telepített',
    'LBL_FTS_INSTALLED_ERR1'            => 'Teljes szöveges keresés képesség nincs telepítve.',
    'LBL_FTS_INSTALLED_ERR2'            => 'Tovább telepíthet, de nem lesz képes használni a teljes szöveges keresés funkciót.  Kérjük, olvassa el az adatbázis szerver telepítői leírását, vagy forduljon a rendszergazdához.',
	...
	'LBL_DBCONF_TITLE_PSWD_INFO_LABEL' => 'SMTP jelszó:',
	...
	'LBL_LANG_BUTTON_UPLOAD'			=> 'Feltöltése',
	...
	'LBL_LICENSE_OC_NUM'				=> 'Offline kliens licenszak száma',
...
$contact_user_link_guid',
	...
	'LBL_SMTPTYPE_EXCHANGE'                 => 'A Microsoft Exchange',
	...
	'LBL_EMAIL_SMTP_SSL_OR_TLS'         => 'SMTP-SSL vagy TLS választható?',
